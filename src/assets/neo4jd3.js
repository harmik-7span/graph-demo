    ...
    var define, module, exports; return (function e(t, n, r) { function s(o, u) { if (!n[o]) { if (!t[o]) { var a = typeof require == "function" && require; if (!u && a) return a(o, !0); if (i) return i(o, !0); var f = new Error("Cannot find module '" + o + "'"); throw f.code = "MODULE_NOT_FOUND", f } var l = n[o] = { exports: {} }; t[o][0].call(l.exports, function (e) { var n = t[o][1][e]; return s(n ? n : e) }, l, l.exports, e, t, n, r) } return n[o].exports } var i = typeof require == "function" && require; for (var o = 0; o < r.length; o++)s(r[o]); return s })({
        1: [function (_dereq_, module, exports) {
            ...
            function Neo4jD3(_selector, _options) {
                var container, graph, info, toolTipinfo, node, nodes, relationship, relationshipOutline, relationshipOverlay, relationshipText, relationships, selector, simulation, svg, svgNodes, svgRelationships, svgScale, svgTranslate,
                    classes2colors = {},
                    justLoaded = false,
                    numClasses = 0,
                    options = {
                ...
                function updateToopTipInfo(d) {
                    ...
                    if (options.toolTipOnNode) {
                        ...
                        if (d.x < 200) {
                            ...
                            document.getElementById("neo4jd3-tooltip").style.left = (d.x - 250) + "px";
                        } else {
                        ...
                        if (d.y < 100) {
                            ...
                            document.getElementById("neo4jd3-tooltip").style.top = (d.y - 240) + "px";
                        } else {
                ...
                function appendOutlineToNode(node) {
                    return node.append('circle')
                        ...
                        }).attr('data-toggle', "tooltip").attr("data-html", true).attr("title", function (d) {
                            let hoverTitleText = "";
                            let hoverIdText = "";
                            let hoverProperties = "";
                ...
                function init(_selector, _options) {
                    ...
                    if (options.toolTipOnNode) {
                        toolTipinfo = appendToolTipOnNode(container);
                    }
